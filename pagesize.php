<?php
      function paginarion($number,$page,$addition) //$number tổng số trang, $page số trang hiện tại
      {
      	if ($number>1) {
      		echo '<ul class="pagination">';
				...
				for ($i=0; $i < $number; $i++) { 
					...
					{
						echo '<li class="page-item" active><a class="page-link" href="?page='.($i+1).$addition.'">'.($i+1).'</a></li>';
					}
				}
