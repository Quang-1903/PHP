...
define("SMTP_UNAME", "testpro213@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "testpr@123"); //Password for SMTP authentication
